...
if __name__ == "__main__":
    ...
    with open('stuff_data/chunk_data.mca', 'wb') as f:
        data = w.get_chunks_NBT_data(0, 0, 1, 1)
        print(data)
        f.write(data)

    chunk: anvil.Chunk = anvil.Chunk.from_region('stuff_data/chunk_data.mca', 0, 0)

    print(chunk.get_block(10, 10, 10))
